...
|**Precondición:**<ol>  <li> Si se le asignaran permisos diferentes al usuario normal como eliminar, actualizar, agregar nuevos items, se debera especificar los permisos a asignar por escrito</li> Si se le asignaran privilegios para acceder a ciertos ap;artados, se debe especificar por escrito a que apartados tendra acceso <li>item2</li> </ol>||
