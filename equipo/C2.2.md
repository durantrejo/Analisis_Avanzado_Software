...
| **Detalle** | El sistema ser capaz de poder capturar los datos registrados que el sistema embedido recolectará a través de la medición de las condiciones del ambiente para ser vistos y analizados dentro del sistema y con una interfaz visual para el usuario.|
