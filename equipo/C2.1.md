...
| Requisito RFN-02: Asignacion de roles| 
| ------------- |
...
| Requisito RFN-05: Configuración de parámetros de control| 
| ------------- |
|**Detalle:** Se podrán configurar parámetros de control máximos y mínimos, de acuerdo con el que el administrador del sistema establezca. |
|**Precondición:**<ol><li>Al configurar los parámetros de control en el sistema, el administrador deberá tener definido el rango que se establecerá para el punto máximo y punto mínimo.</li><li>El administrador deberá acceder a la interfaz de configuración de parámetros de control.</li></ol>|
|**Secuencia normal:**<ol><li>Al configurar los parámetros de control, el administrador deberá ingresar el nuevo parametro para una temperatura mínima y una máxima.</li><li>Al finalizar de ingresar los nuevos datos, se habilitará la opción de «guardar modificacion».</li></ol>|
|**Post-condición:**<ol><li>El sistema mostrará un mensaje especificando el tipo de parametro de control que se ha configurado y confirmará que se efectuó de manera exitosa.</li></ol>|
|**Excepciones:**<ol><li>El sistema mostrará un mensaje indicando que ocurrió un error.</li></ol>|

| Requisito RFN-06: Recolección de datos| 
| ------------- |
|**Detalle:**  El sistema deberá ser capaz de recolectar las condiciones ambientales tales como temperatura, humedad, iluminación, entre otros, de acuerdo a un tiempo previamente establecido.|
|**Precondición:**<ol><li> </li></ol>|
|**Secuencia normal:**<ol><li> </li></ol>|
|**Post-condición:**<ol><li> </li></ol>|
|**Excepciones:**<ol><li> </li></ol>|

| Requisito RFN-07: Gráficos de comportamiento| 
| ------------- |
|**Detalle:** El sistema deberá generar gráficos de barra, mapas de calor o cualquier otro que permita observar comportamiento de la muestra adquirida, utilizando colores para indicar si esta dentro o fuera de control. |
|**Precondición:**<ol><li> </li></ol>|
|**Secuencia normal:**<ol><li> </li></ol>|
|**Post-condición:**<ol><li> </li></ol>|
|**Excepciones:**<ol><li> </li></ol>|
...
| ------------- |
|**Detalle:** .Tomando el valor asignado al sensor por el adiministrador ell base al parametro RFN-04 se tomara registros del sensor que este fuera de la medida de control, la hora, minuto y segundos|
