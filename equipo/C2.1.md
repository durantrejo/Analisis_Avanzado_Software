...
|**Secuencia normal:**<ol><li> Se procesara y almacenara los dadtos capturados por los sensores </li> <li> Posteriormente se mostraran los datos a los usuarios correspondientes en la interfaz del sistema. </li>
   
   <li>Al finalizar de ingresar los nuevos datos, se habilitará la opción de «guardar modificacion».</li></ol>|
